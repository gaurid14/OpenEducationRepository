...
from langgraph_agents.agents.submission_agent import extract_file_metadata,  submission_agent
from langgraph_agents.agents.evaluation_agent import format_metadata, extract_pdf_page_count, summarize_pdf_with_gemini, transcribe_video

graph = StateGraph(dict)

async def node_extract_metadata(state: dict) -> dict:
...
async def route_after_metadata(state: dict) -> str:
...
graph.set_entry_point("submission_agent")
